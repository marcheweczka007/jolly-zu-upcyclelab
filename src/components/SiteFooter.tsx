        ...
        <div className="grid gap-12 md:grid-cols-[2fr_1fr_1fr]">
          <div>
            ...
            <p className="mt-6 max-w-sm text-sm text-cream/70">
              JollyZu — handmade upcycled bags from Edinburgh. Slow fashion. Small batch. Built to last.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/about" className="hover:text-mustard">About</Link></li>
              <li><Link to="/contact" className="hover:text-mustard">Contact</Link></li>
              <li><a href={SHOP_URL} target="_blank" rel="noreferrer" className="hover:text-mustard">Shop ↗</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="https://instagram.com/upcycle.lab.jollyzu" target="_blank" rel="noreferrer" className="hover:text-mustard">Instagram ↗</a></li>
              <li><a href={SHOP_URL} target="_blank" rel="noreferrer" className="hover:text-mustard">Vinted ↗</a></li>
            </ul>
          </div>
        </div>
