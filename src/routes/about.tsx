...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Meet Zuza, the indie maker turning rescued textiles into one-of-a-kind upcycled bags from her Edinburgh studio." },
    ...
    <div className="min-h-screen bg-cream text-ink">
      ...
      <section className="mx-auto max-w-7xl px-5 pb-12 pt-8 md:px-8 md:pb-20 md:pt-16">
        ...
        <h1 className="text-display text-[14vw] leading-[0.85] md:text-[9rem]">
          One person.<br />
          One studio.<br />
          <span className="bg-mustard px-3 inline-block -rotate-1">Zero new fabric.</span>
        </h1>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-5 pb-20 md:grid md:grid-cols-12 md:gap-16 md:px-8 md:pb-32">
        ...
        <div className="mt-12 space-y-6 text-lg text-ink/80 md:col-span-7 md:mt-0">
          ...
          <p>
            Every piece is designed around the materials I find. That means no two bags are identical, and none of them will ever exist again. It also means the design has to bend to what's available — and honestly, that's where the best ideas come from.
          </p>
          <p>
            I sew everything myself. I package everything myself. Plastic-free, posted direct from Edinburgh.
          </p>
          <div className="pt-4">
      ...
      <Marquee items={["Edinburgh Studio", "Hand Cut", "Hand Sewn", "Hand Packed", "Slow Fashion"]} />
      ...
      <section className="mx-auto max-w-7xl px-5 py-20 md:px-8 md:py-32">
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-3">
          {[
            { t: "Less, but better.", d: "Small batches. No restocks. Quality over volume — every single time." },
            { t: "Waste is a design brief.", d: "Constraints from rescued materials make the bags weirder, bolder, more honest." },
            { t: "Made by humans.", d: "No factories, no faceless brands. Just one person and a sewing machine." },
          ].map((v) => (
      ...
      <section className="bg-ink py-24 text-cream md:py-32">
        <div className="mx-auto max-w-7xl px-5 text-center md:px-8">
          <h2 className="text-display text-5xl md:text-8xl">
            Wear something<br /><span className="text-mustard">no one else has.</span>
          </h2>
